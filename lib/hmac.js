...
exports.getSecret = function (blobId, callback) {
  db.query('SELECT `auth_secret` FROM `blob` WHERE id = ?',
           [blobId],
           function (err, rows) {
             if (err) {
               callback(err);
...
exports.middleware = function (req, res, next) {
  ...
  var secret = hmac.update(req.body.blob_id).digest('hex').toLowerCase();
