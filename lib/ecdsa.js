...
var ecdsa = function(req,res,next) {
    ...
    console.log("ecdsa: canonicalRequest:", canonicalRequest)
    ...
    console.log("ecdsa: stringToSign:", stringToSign)
    ...
    console.log("ecdsa: attempting to verify message signature")
    Message.verifyMessageSignature(
        data,
        remote, 
        function(err,resp) {
            console.log("ecdsa: err: ", err, " response: ", resp)
            if (err) {
