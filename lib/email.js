...
function makeNotify(file, subject) {
    var contents_html = fs.readFileSync(__dirname+ '/email-' + file + '.html').toString(),
        contents_text = fs.readFileSync(__dirname+ '/email-' + file + '.txt').toString();
...
exports.notifypasswordchange = makeNotify("notifypasswordchange", "RippleID password change");
exports.notify2FAChange      = makeNotify("notify-2fa-change",    "RippleID 2FA change");
exports.notifynamechange     = makeNotify("notifynamechange",     "RippleID - Ripple name change");
exports.notifyVerifyOk       = makeNotify("notify-verify-ok",     "RippleID has verified your account");
exports.notifyVerifyFail     = makeNotify("notify-verify-fail",   "RippleID account not verified");
