...
var generateMessage = function(email,token,name,hostlink) {
    var message    = {
       ...
       to:        [],
       subject:    "Please verify your email address on Ripple.",
       "headers": {
...
exports.notifypasswordchange   = makeNotify("password-change",    "Ripple password change");
exports.notify2FAChange        = makeNotify("phone-change",       "Ripple 2FA change");
exports.notifynamechange       = makeNotify("name-change",        "Ripple - Ripple name change");
exports.notifyVerifyOk         = makeNotify("verify-ok",          "Ripple has verified your identity information");
exports.notifyVerifyFail       = makeNotify("verify-fail",        "Ripple account not verified");
exports.notifyVerifyPending    = makeNotify("verify-pending",     "Ripple needs more time to review your account");
exports.notifyStepNull         = makeNotify("step-null",          "Ripple request for information");
exports.notifyStepJumioID      = makeNotify("step-jumio-id",      "Ripple requires additional information");
exports.notifyStepJumioDoc     = makeNotify("step-jumio-doc",     "Ripple requires additional information");
exports.notifyStepJumioCompany = makeNotify("step-jumio-company", "Ripple requires additional information");
exports.notifyStepJumioID2     = makeNotify("step-jumio-id2",     "Ripple requires additional information");
exports.notifyStepJumioComID   = makeNotify("step-jumio-com-id",  "Ripple requires additional information");
