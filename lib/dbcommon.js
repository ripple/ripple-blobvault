...
var dbcommon = function(db) {
    ...
    var create = function(params,cb) {
        ...
        // Convert encrypted secret from base64 to binary
        var encrypted_secret = new Buffer(params.encrypted_secret, 'base64');
        db('blob')
        .insert({
            id: blobId, 
            username: username, 
        ...
        .catch(function(error) {
            console.log("dbcommon.create Error:", error);
            // we mask the actual error
    ...
    var read = function(params, cb) {
        ...
        .catch(function(error) {
            ...
            console.log("dbcommon.read Error:", error);
    ...
    var update = function(params,cb) {
        ...
        .catch(function(error) {
            ...
            console.log("dbcommon.update Error:", error);
    ...
    var update_where = function(params,cb) {
        ...
        .catch(function(error) {
            console.log("dbcommon.update_where Error:", error);
            // obj is the real error, but we mask it 
            cb({error:new Error("Database update error")}); 
        })
    }
    ...
    var read_where = function(params, cb) {
        ...
        .then(cb)
        .catch(function(error) {
            console.log("dbcommon.read_where Error: ", error);
            // obj is the real error, but we mask it
    ...
    self.blobPatch = function(size,req,res,cb) {
        ...
        .catch(function(obj) {
            console.log("dbcommon.blobPatch Error: ", obj);
            // obj is the real error, but we mask it 
    ...
    self.blobConsolidate = function(size,req,res,cb) {
        ...
        db.transaction(function(t) {
            ...
            .catch(function(error) {
                console.log("dbcommon.blobConsolidate Error: ", error);
                t.rollback()
                // obj is the real error, but we mask it 
    ...
    self.hmac_getSecret = function(params, cb) {
        ...
        .catch(function(error) {
            // obj is the real error, but we mask it
            console.log("dbcommon.hmac_getSecret Error: ", error);
