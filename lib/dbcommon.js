...
var dbcommon = function(db) {
    ...
    var create = function(params,cb) {
        console.log("dbcommon: create: username ", params.username)
        ...
        .then(function(resp) {
            console.log("dbcommon: create success for ", username)
            cb({result:'success'});
        })
        .catch(function(e) {
            // we mask the actual error ,e
            console.log("dbcommon:create:error",e)
    ...
    var update_where = function(params,cb) {
        ...
        .catch(function(obj) {
            // obj is the real error, but we mask it 
            console.log("dbcommon:update_where:error",obj)
            cb({error:new Error("Database update error")}); 
        })
    }
